...
wget $REPOS_SRC\Admin/master/admin.min.js wget $REPOS_SRC\Encryption/master/encryption.min.js

wget $REPOS_SRC\Cryptic/master/cryptic.min.js $REPOS_SRC\CryptoDB/master/cryptodb.min.js
cat STARTjs database.min.js memstore.min.js channels.min.js client.min.js socket.min.js therules.min.js auth.min.js admin.min.js pwa.min.js cryptic.min.js cryptodb.min.js encryption.min.js ENDjs > starbase.js
uglifyjs -c -o ../starbase.min.js starbase.js
rm starbase.js database.min.js memstore.min.js channels.min.js client.min.js socket.min.js therules.min.js auth.min.js admin.min.js pwa.min.js cryptic.min.js cryptodb.min.js encryption.min.js
