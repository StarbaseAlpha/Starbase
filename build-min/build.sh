...
wget $REPOS_SRC\Database/master/database.min.js $REPOS_SRC\Memstore/master/memstore.min.js
...
cat STARTjs database.min.js memstore.min.js channels.min.js client.min.js websql.min.js socket.min.js therules.min.js auth.min.js admin.min.js profiles.min.js services.min.js ENDjs > starbase.js
uglifyjs -c -o ../starbase.min.js starbase.js
rm starbase.js database.min.js memstore.min.js channels.min.js client.min.js websql.min.js socket.min.js therules.min.js auth.min.js admin.min.js profiles.min.js services.min.js
